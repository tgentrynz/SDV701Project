    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                // Add handler for back button presses.
        ...
        // Handler for pressing back buttons
        internal void App_BackRequested(object sender, Windows.UI.Core.BackRequestedEventArgs e)
        {
            if (!e.Handled)
                BackPress();
        }

        internal static void BackPress()
        {
            Frame rootFrame = Window.Current.Content as Frame;
            if (rootFrame == null)
                return;
